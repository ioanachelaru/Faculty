...
public class Worker2 {
    ...
    public SynchronizedLinkedList<Integer> readPoli(String file_name){
        SynchronizedLinkedList<Integer> lst = new SynchronizedLinkedList<>();
    ...
    public void writePoli(SynchronizedLinkedList<Integer> list, String file_name) throws IOException {
    ...
    public SynchronizedLinkedList<Integer> generatePoli(){
        int max = 20, min = 1;

        Random r = new Random();
        int size = r.nextInt((max - min) + 1) + min;

        SynchronizedLinkedList<Integer> poli = new SynchronizedLinkedList<>();
